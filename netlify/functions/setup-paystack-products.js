// netlify/functions/setup-paystack-products.js
// ONE-TIME USE. Visit:
//   https://YOUR-SITE.netlify.app/.netlify/functions/setup-paystack-products?key=YOUR_ADMIN_API_PASSWORD
...
exports.handler = async (event) => {
  ...
  if (!process.env.ADMIN_API_PASSWORD || key !== process.env.ADMIN_API_PASSWORD) {
    return { statusCode: 401, body: "Unauthorized. Add ?key=YOUR_ADMIN_API_PASSWORD to the URL." };
  }
  ...
  return {
    ...
    body: JSON.stringify({ created: succeeded, total: results.length, results }, null, 2),
  };
};
